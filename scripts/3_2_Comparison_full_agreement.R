...
overall_all_agree_fig <- as.data.frame(conf_epfl_mturk_agree$overall) %>% 
  ...
  mutate(method = str_replace_all(method, 
                                  c("conf_epfl_" = "", 
                                    "\\$overall" = "",
                                    "mistral_agree_all_2" = "Mistral \n(7B) prompt 2",
                                    "mistral_agree_all_1" = "Mistral \n(7B) prompt 1",
                                    "mistral_agree_all_3" = "Mistral \n(7B) prompt 3",
                                    "mistral_agree_all_4" = "Mistral \n(7B) prompt 4",
                                    "mistral_agree_all_5" = "Mistral \n(7B) prompt 5",
                                    "mistral_agree_all_6" = "Mistral \n(7B) prompt 6",
                                    "mistral_agree_all_7" = "Mistral \n(7B) prompt 7",
                                    "mistral_agree_all_8" = "Mistral \n(7B) prompt 8",
                                    "mixtral_agree_all_2" = "Mixtral \n(8x7B) prompt 2",
                                    "mixtral_agree_all_1" = "Mixtral \n(8x7B) prompt 1",
                                    "mixtral_agree_all_3" = "Mixtral \n(8x7B) prompt 3",
                                    "mixtral_agree_all_4" = "Mixtral \n(8x7B) prompt 4",
                                    "mixtral_agree_all_5" = "Mixtral \n(8x7B) prompt 5",
                                    "mixtral_agree_all_6" = "Mixtral \n(8x7B) prompt 6",
                                    "mixtral_agree_all_7" = "Mixtral \n(8x7B) prompt 7",
                                    "mixtral_agree_all_8" = "Mixtral \n(8x7B) prompt 8",
                                    "mixtral_agree_all_2" = "Mixtral \n(8x7B) prompt 2",
